...
function Home(){
    return <div className="page">
            <div className="section" id="character1">
                <h1>STEAM Play</h1>
                <p id='homepagetext'>Learning with curiosity, creativity, and movement. We believe
                ...
                {/* <img id='doodle' src='character1.png' alt='Girl in Lab Coat'></img>                  */}
        </div>
